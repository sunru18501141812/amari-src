...
Em.I18n.translations = {
  ...
  'app.name':'NBE',
  'app.name.subtitle':'NBE - {0}',
  'app.name.subtitle.experimental':'NBE Experimental',
  ...
  'app.redirectIssuePopup.body': 'For single sign-on, make sure that Knox Gateway and NBE Server are located on the same host or subdomain.' +
    '<br/>Alternatively login as an NBE local user using the local login page.<br />' +
    '<a rel="noopener noreferrer" href="{0}" target="_blank">{0}</a>',

  'app.loadingPlaceholder': 'Loading...',
  'app.versionMismatchAlert.title': 'NBE Server / Web Client Version Mismatch',
  'app.versionMismatchAlert.body': 'NBE Server and Web Client versions do not match:<br> ' +
    '<br>NBE Server: <strong>{0}</strong>' +
    '<br>NBE Web Client: <strong>{1}</strong><br>' +
    '<br>This typically happens after upgrading NBE due to NBE Web Client code cached in the browser.' +
  ...
  'app.settings.admin.all.privileges': 'This user is an NBE Admin and has all privileges.',
  ...
  'common.persist.error' : 'Error in persisting web client state at NBE server. Server respond with following error message:',
  'common.update.error' : 'Error in retrieving web client state from NBE server',
  'common.tags': 'Tags',
  ...
  'common.hostLog.popup.logDir.path':'/var/lib/NBE-agent/data/',   // TODO, this hardcoded path needs to be removed.
  ...
  'popup.dependent.configs.title.recommendation': 'Based on your configuration changes, NBE is recommending the following dependent configuration changes.',
  'popup.dependent.configs.title.values': 'NBE will update all checked configuration changes to the <b>Recommended Value</b>. Uncheck any configuration to retain the <b>Current Value</b>.',
  ...
  'popup.jdkValidation.body': 'The {0} Stack requires JDK {1} but NBE is configured for JDK {2}. This could result in error or problems with running your cluster.',
  ...
  'login.error.bad.connection':'Unable to connect to NBE Server. Confirm NBE Server is running and you can reach NBE Server from this machine.',

  'titlebar.alerts.noAlerts': 'No Alerts',

  'graphs.noData.title': 'No Data',
  'graphs.noData.message': 'No Data Available',
  'graphs.noData.tooltip.title': 'No Data Available. The NBE Metrics service may be not installed or inaccessible',
  ...
  'topnav.help.href':'https://cwiki.apache.org/confluence/display/NBE/NBE',
  ...
  'installer.controls.checkConnection.popover':'This action will check accessibility of {0} host and port from NBE Server host',
  ...
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg': 'NBE is unable to confirm access to the Public Repositories, which means you might not have Internet access and will not be able to use the Public Repository option for installing the software. Your choices:',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg1': 'Configure your hosts for access to the Internet.',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg2': 'If you are using an Internet Proxy, refer to the NBE Documentation on how to configure NBE to use the Internet Proxy.',
  ...
  'installer.step1.advancedRepo.useRedhatSatellite.warning': "In order for NBE to install packages from the right" +
  ...
  'installer.step2.manualInstall.info':'By not using SSH to connect to the target hosts, you must manually install and' +
    ' start the NBE Agent on each host in order for the wizard to perform the necessary configurations and' +
    ' software installs.',
  ...
  'installer.step2.javaHome.tooltip.content' : 'Path to 64-bit JAVA_HOME. /usr/jdk/jdk1.6.0_31 is the default used by NBE. You can override this to a specific path that contains the JDK. <br/> Note: the path must be valid on <b>ALL</b> hosts in your cluster.',
  ...
  'installer.step2.automaticInstall.tooltip.content':'NBE will automatically install and register the NBE Agent on each host prior to the cluster installation.',
  ...
  'installer.step2.useSsh.tooltip.content':'The <b>SSH Private Key File</b> is used to connect to the target hosts in your cluster to install the NBE Agent.',
  ...
  'installer.step2.manualInstall.tooltip.content':'Manually registering the NBE Agent on each host eliminates the need for SSH and should be performed prior to continuing cluster installation.',
  'installer.step2.manualInstall.tooltip.content_no_ssh':'Manually registering the NBE Agent on each host should be performed prior to continuing cluster installation.',
  'installer.step2.manualInstall.popup.header':'Before You Proceed',
  'installer.step2.manualInstall.popup.body':'You must install NBE Agents on each host you want to manage before you proceed.',
  ...
  'installer.step2.sshUser.toolTip':'The user account used to install the NBE Agent on the target host(s) via SSH. This user must be set up with passwordless SSH and sudo access on all the target host(s)',
  ...
  'installer.step2.agentUser':'NBE Agent User Account',
  'installer.step2.agentUser.toolTip':'The user account used to run the NBE Agent daemon on the target host(s). This user must be set up with passwordless sudo access on all the target host(s)',
  'installer.step2.bootStrap.error':'Errors were encountered while setting up NBE Agents on the hosts.',
  'installer.step2.bootStrap.inProgress':'Please wait while NBE Agents are being set up on the hosts. This can take several minutes depending on the number of hosts.',
  'installer.step2.bootStrap.header':'Setting Up NBE Agents',
  'installer.step2.skipHostChecks.label': 'Skip host checks',
  'installer.step2.skipHostChecks.popup.header': 'Warning',
  'installer.step2.skipHostChecks.popup.body': 'By skipping host checks, NBE will not check and warn if any issues with the host are identified and the host will be added to the cluster as is.',
  ...
  'installer.step4.ambariMetricsCheck.popup.header': 'NBE Metrics',
  'installer.step4.ambariMetricsCheck.popup.body':'NBE Metrics collects metrics from the cluster and makes them available to NBE.  If you do not install NBE Metrics service, metrics will not be accessible from NBE.  Are you sure you want to proceed without NBE Metrics?',
  ...
  'installer.step4.ambariLogsearchCheck.popup.header': 'NBE Logsearch',
  'installer.step4.ambariLogsearchCheck.popup.body':'Since NBE Infra is not selected, you must supply your own Solr to make Log Search work. Are you sure you want to proceed?',
  ...
  'installer.step4.rangerRequirements.popup.body.requirements': '<ol><li>You must have an <strong>MySQL/Oracle/Postgres/MSSQL/SQL Anywhere Server</strong> database instance running to be used by Ranger.</li>' +
    ...
    '<li>Execute the following command on the NBE Server host. Replace <code>database-type</code> with <strong>mysql|oracle|postgres|mssql|sqlanywhere</strong> and <code>/jdbc/driver/path</code> based on the location of corresponding JDBC driver:' +
    '<pre>NBE-server setup --jdbc-db={database-type} --jdbc-driver={/jdbc/driver/path}</pre></li></ol>',
  ...
  'installer.step7.databasesTab.radioButton.default':'Use NBE Database',
  ...
  'installer.step7.popup.mySQLWarning.body':'You cannot install a \"New MySQL Database\" for Hive on the same host as the NBE Server MySQL Server. Please go back to <b>Assign Masters</b> and reassign Hive to another host <b>OR</b> choose \"Existing MySQL Database\" option to specify the Database Credentials and URL for the NBE Server MySQL Server instance. If you choose \"Existing MySQL Database\" option, you need to perform the Hive prerequisite steps to prepare the MySQL Server instance for Hive.',
  ...
  'installer.step7.recommendations.popover.message': '<p>Based on your configuration changes, NBE is recommending the following dependent configuration changes. NBE has updated all checked configuration changes to the <strong>Recommended Value</strong>. Uncheck any configuration to retain the <strong>Original Value</strong>.</p>',
  ...
  'installer.step9.status.hosts.heartbeat_lost': 'NBE agent is not running on {0} hosts.',
  'installer.step9.host.heartbeat_lost': 'Heartbeat lost for the host',
  'installer.step9.host.heartbeat_lost_popup': 'NBE agent process is not heartbeating on the host',
  ...
  'installer.step9.host.status.noTasks': 'NBE server did not schedule any tasks on the host. Either the service component on the host is already in installed state <b>OR</b> the pre-check of host reachability failed.',
  ...
  'alerts.add.wizard.step1.body.script.description':'Defer all functionality to a Python script accessible to the NBE agents from a specified relative or absolute path',
  ...
  'alerts.actions.editRepeatTolerance.description': 'Set the number of alert checks to perform before dispatching a notification. ' +
    'If during an alert check a state change occurs, NBE will attempt to check this number of times before dispatching a notification. ' +
  ...
  'admin.authentication.form.method.database':'Use NBE Database to authenticate users',
  ...
  'admin.kerberos.credentials.store.hint.supported': 'When checked, NBE will store the KDC Admin credentials so they are not required to be re-entered during future changes of services, hosts, and components.',
  'admin.kerberos.credentials.store.hint.not.supported': 'NBE is not configured for storing credentials',
  ...
  'admin.kerberos.credentials.remove.confirmation.body': 'You are about to remove the KDC Credentials from NBE. Are you sure?',
  ...
  'admin.kerberos.wizard.step1.info.body': 'Welcome to the NBE Security Wizard. Use this wizard to enable kerberos security in your cluster. </br>Let\'s get started.',
  ...
  'admin.kerberos.wizard.step1.option.kdc.condition.1': 'NBE Server and cluster hosts have network access to both the KDC and KDC admin hosts.',
  'admin.kerberos.wizard.step1.option.kdc.condition.2': 'KDC administrative credentials are on-hand.',
  'admin.kerberos.wizard.step1.option.kdc.condition.3': 'The Java Cryptography Extensions (JCE) have been setup on the NBE Server host and all hosts in the cluster.',
  ...
  'admin.kerberos.wizard.step1.option.manual.condition.3': 'The Java Cryptography Extensions (JCE) have been setup on the NBE Server host and all hosts in the cluster',
  'admin.kerberos.wizard.step1.option.manual.condition.4': 'The Service and NBE Principals will be manually created in the KDC before completing this wizard',
  'admin.kerberos.wizard.step1.option.manual.condition.5': 'The keytabs for the Service and NBE Principals will be manually created and distributed to cluster hosts before completing this wizard',
  'admin.kerberos.wizard.step1.option.ad': 'Existing Active Directory',
  'admin.kerberos.wizard.step1.option.ad.condition.1': 'NBE Server and cluster hosts have network access to the Domain Controllers.',
  ...
  'admin.kerberos.wizard.step1.option.ad.condition.5': 'The Java Cryptography Extensions (JCE) have been setup on the NBE Server host and all hosts in the cluster.',
  ...
  'admin.kerberos.wizard.step1.option.ipa.condition.3': 'If you do not plan on using NBE to manage the krb5.conf, ensure the following is set in each krb5.conf file in your cluster: default_ccache_name = /tmp/krb5cc_%{uid}',
  'admin.kerberos.wizard.step1.option.ipa.condition.4': 'The Java Cryptography Extensions (JCE) have been setup on the NBE Server host and all hosts in the cluster.',
  ...
  'admin.kerberos.wizard.step5.moreInfoNonManual.body': 'Using the <b>Download CSV button</b>, you can download a csv file which contains a list of the principals and keytabs that will automatically be created by NBE.',
  'admin.kerberos.wizard.step5.moreInfoManual.body': 'Important: Use the <b>Download CSV</b> button to obtain a list of the <b>required</b> principals and keytabs that are needed by NBE to enable Kerberos in the cluster. <b>Do not proceed</b> until you have manually created and distributed the principals and keytabs to the cluster hosts.',
  ...
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.proceed': 'You will be able to proceed once NBE detects that the NameNode is in Safe Mode and the Checkpoint has been created successfully.',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.proceed': 'You will be able to proceed once NBE detects that the NameNodes are in Safe Mode and the Checkpoints have been created successfully.',
  ...
  'admin.highAvailability.confirmManualRollbackBody':'You are in the process of enabling NameNode HA. If you exit now, you must follow manual instructions to revert back to the non-HA setup as documented in the NBE User Guide\'s <i>Rolling Back NameNode HA</i> section.  Are you sure you want to exit the wizard?',
  ...
  'admin.rm_highAvailability.closePopup':'Enable ResourceManager HA Wizard is in progress. You must allow the wizard to complete for NBE to be in usable state. If you choose to quit, you must follow manual instructions to complete or revert enabling ResourceManager HA as documented in the NBE User Guide. Are you sure you want to exit the wizard?',
  ...
  'admin.highAvailability.wizard.step7.task1.title':'Start NBE Infra',
  ...
  'admin.highAvailability.wizard.step6.body':
    ...
    '<li>You will be able to proceed once NBE detects that the JournalNodes have been initialized successfully.</li>' +
    '</ol>',
  'admin.highAvailability.wizard.step4.body':
    ...
    '<li>Once in Safe Mode, create a Checkpoint:' +
    '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'</div></li>' +
    '<li>You will be able to proceed once NBE detects that the NameNode is in Safe Mode and the Checkpoint has been created successfully.</li>'+
  ...
  'admin.ra_highAvailability.closePopup':'Enable Ranger Admin HA Wizard is in progress. You must allow the wizard to complete for NBE to be in usable state. ' +
  'If you choose to quit, you must follow manual instructions to complete or revert enabling Ranger Admin HA as documented in the NBE User Guide. Are you sure you want to exit the wizard?',
  ...
  'admin.nameNodeFederation.closePopup2': 'Add New HDFS Namespace Wizard is in progress. You must allow the wizard to complete for NBE to be in usable state. If you choose to quit, you must follow manual instructions to complete or revert Add New HDFS Namespace as documented in the NBE User Guide. Are you sure you want to exit the wizard?',
  'admin.nameNodeFederation.wizard.step1.header': 'Get Started',
  'admin.nameNodeFederation.wizard.step1.body':'This wizard will walk you through the process of setting up a new Highly Available NameNode pair that will be used to create a new HDFS namespace, allowing you to use NBE to manage multiple HDFS namespaces and take advantage of HDFS Federation.',
  ...
  'admin.security.step1.body.header': 'Important: Before configuring NBE to manage your Kerberos-enabled cluster, ' +
  ...
  'admin.security.status.error' : 'Error in retrieving cluster security status from NBE server',
  ...
  'admin.serviceAutoStart.header.text': "NBE services can be configured to start automatically on system boot. Each service can be configured to start all components, masters and workers, or selectively.",
  ...
  'admin.stackVersions.manageVersions.popup.body': 'You are about to leave the <b>Cluster Management</b> interface' +
    ' and go to the <b>NBE Administration</b> interface. You can return to cluster management by using the' +
    ' “Go to Dashboard” link in the NBE Administration > Clusters section.',
  ...
  'admin.stackVersions.version.errors.outOfSync.desc': 'One of more host components did not report the version that NBE expected.' +
  ...
  'admin.stackVersions.version.upgrade.alertsWarning': 'Cluster alerts will still be visible and recorded in NBE but notifications (such as Email and SNMP) will be suppressed during the upgrade.',
  ...
  'admin.stackUpgrade.failedHosts.isOutOfSync.options.second' : '<b>Restart</b> the NBE Agent',
  ...
  'services.service.delete.popup.warning': 'The <b>{0} service will be removed from NBE and all configurations' +
  ...
  'services.service.config.database.msg.jdbcSetup': 'Be sure you have run:<br/>' +
    '<b>NBE-server setup --jdbc-db={0} --jdbc-driver=/path/to/{0}/{1}</b> ' +
    'on the NBE Server host to make the JDBC driver available and to enable testing the database connection.',
  ...
  'services.service.config.database.msg.jdbcSetup.detailed': 'To use {0} with {6}, you must <a rel="noopener noreferrer" href="{3}" target="_blank">' +
    'download the {4} from {0}</a>. Once downloaded to the NBE Server host, run: <br/>' +
    '<b>NBE-server setup --jdbc-db={1} --jdbc-driver=/path/to/{1}/{2}</b>',
  ...
  'services.reassign.closePopup':'Move {0} wizard is in progress. You must allow the wizard to complete for NBE to be in usable state. If you choose to quit, you must follow manual instructions to complete or revert move {0} wizard as documented in the NBE User Guide. Are you sure you want to exit the wizard?',
  ...
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg1': '<b>Please note: </b>Once removed, NBE will ignore future communications from these hosts. As part of the removal process, packages will not be removed, so please do not attempt to manually start the services on the host once they have been removed from NBE. If you wish to re-add the hosts to the cluster, please completely clean the hosts before attempting to add them.',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg2': 'To ensure they are completely removed from NBE database,',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg3': 'please make sure the NBE Agent process is completely stopped on these hosts before proceeding.',
  ...
  'hosts.host.stackVersions.outOfSync.tooltip': 'This version is Out of Sync on this host. Out of Sync can occur ' +
    ...
    'Click Install to have NBE install the packages for this version to get this host in sync.',
  ...
  'hosts.host.zooKeeper.configs.save.note': 'This configuration is created by NBE while installing/deleting zookeeper component on a host',
  ...
  'hosts.host.storm.configs.save.note': 'This configuration is created by NBE while installing/deleting storm component on a host',
  ...
  'hosts.host.configs.save.note': 'This configuration is created by NBE while installing/deleting {0} component on a host',
  ...
  'hosts.delete.popup.body.msg1':'By removing this host, NBE will ignore future communications from this host. Software packages will not be removed from the host. The components on the host should not be restarted. If you wish to readd this host to the cluster, be sure to clean the host.',
  ...
  'hosts.delete.popup.body.msg6':'To completely delete the Host, first stop NBE-agent on it.',
  'hosts.delete.popup.body.msg7':'<b>WARNING!</b> {0} should be decommissioned first to prevent data loss.',
  'hosts.delete.popup.body.msg.unknownComponents':'This host does not appear to be online and NBE communication with the Agent has been lost.',
  ...
  'admin.addHawqStandby.closePopup':'Add HAWQ Standby Master Wizard is in progress. You must allow the wizard to' +
      ' complete for NBE to be in usable state. If you choose to quit, you must follow documented manual' +
  ...
  'admin.removeHawqStandby.wizard.step2.confirmPopup.body': 'Do you wish to continue with removing HAWQ Standby Master? Please confirm, before proceeding as you will not be able to rollback from NBE.',
  ...
  'admin.removeHawqStandby.closePopup':'Remove HAWQ Standby Wizard is in progress. You must allow the wizard to' +
      ' complete for NBE to be in usable state. If you choose to quit, you must follow manual instructions to' +
  ...
  'admin.activateHawqStandby.wizard.step2.confirmPopup.body': 'Do you wish to continue with activating HAWQ Standy Master? ' +
      'Please confirm, before proceeding as you will not be able to rollback from NBE.',
